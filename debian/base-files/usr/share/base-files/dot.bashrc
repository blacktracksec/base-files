...
case "$TERM" in
xterm*|rxvt*)
    PS1="\[\033[1;32m\]──|\033[1;37m"$(ifconfig | grep inet | egrep -v "127|inet6" | awk '{print $2}')"\033[1;32m|──[\[\033[1;37m\]\u\[\033[01;32m\]@\[\033[01;34m\]\h\[\033[1;32m\]]\342\224\200[\[\033[1;37m\]\w\[\033[1;32m\]]\n\[\033[1;32m\]\342\224\224\342\224\200\342\224\200\342\225\274 [\[\e[01;33m\]★\[\e[01;32m\]]\$ \[\e[0m\]"
    ;;
*)
    ;;
esac
